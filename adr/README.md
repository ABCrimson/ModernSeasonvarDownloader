...
| [0002](0002-aggressive-pre-release-policy.md) | Aggressive pre-release policy (RC / beta / canary pins) | 2026-08-22 | accepted |
| [0003](0003-sqlite-owned-by-core.md) | SQLite state owned by the core, shared by CLI and GUI | 2026-08-22 | accepted |
| [0004](0004-recreate-repository-instead-of-reusing-fork.md) | Delete the upstream fork and recreate a clean repository | 2026-08-22 | accepted (executed at M0) |
